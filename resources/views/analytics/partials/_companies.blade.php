                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="row main-canvas">
                                        <div class="col canvas">
                                            ...
                                            @endphp
                                            <img style="margin-bottom: 40px" src="https://quickchart.io/chart?bkg=white&width=100&height=100&c={ type: 'doughnut', data: { datasets: [ { data: [<?php echo implode(",",array_reverse($transport_count))?>], backgroundColor: [ 'rgb(255, 99, 132, 0.4)', 'rgba(132, 153, 255, 1)', 'rgba(75, 227, 149, 1)'], }, ], labels: [], },
  options: {
    plugins: {
      doughnutlabel: {
        labels: [{
          text: '<?php echo $efficiency ?> %',
          font: {
            size: 20,
            weight: 'bold'
          }
          ...
          text: ''
                                    ...
                                    <div class="row workstat-row">
                                        ...
                                        <div class="col-sm-4 value-col"><span
                                                    class="value value-green" style="margin-top: -21px">{{$transport_count[0]}}</span></div>
                                    </div>
                                    <div class="row workstat-row">
                                        <div class="col-sm-8 title-col">{{ trans('all.quantity_of_partner_transport') }}</div>
                                        <div class="col-sm-4 value-col"><span class="value value-blue value-grey" style="margin-top: -21px">0</span></div>
                                    </div>
                                    <div class="row workstat-row">
                                        <div class="col-sm-8 title-col">{{ trans('all.total_number_of_transport') }}</div>
                                        <div class="col-sm-4 value-col"><span
                                                    class="value value-grey" style="margin-top: -21px">{{$transport_count[0]}}</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row workstat_block">
                        <div class="col-sm-12">
                            ...
                            <div class="row workstat-row">
                                ...
                                <div class="col-sm-4 value-col"><span
                                            class="value /*value-green*/" style="margin-top: -21px">{{$stat['duration']}}</span></div>
                            </div>
                            <div class="row workstat-row">
                                <div class="col-sm-8 title-col /*control-label*/">{{ trans('all.quantity_of_passed_km') }}</div>
                                <div class="col-sm-4 value-col"><span
                                            class="value /*value-red*/" style="margin-top: -21px">{{$stat['distance_full']}} {{ trans('all.km') }}</span>
                                </div>
                            </div>
                            <div class="row workstat-row">
                                <div class="col-sm-8 title-col /*control-label*/">{{trans('all.quantity_of_passed_km_empty')}}</div>
                                <div class="col-sm-4 value-col"><span
                                            class="value /*value-red*/" style="margin-top: -21px">{{$stat['distance_empty']}} {{ trans('all.km') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="row workstat-graphs">
                                <div class="col-xs-7">
                                    ...
                                    @endphp
                                    <img style="margin-bottom: 10px" src="https://quickchart.io/chart?width=100&height=100&c={type:'doughnut',data:{datasets:[{data: [{{100-$efficiency_chart1}},{{$efficiency_chart1}}]}]}}">
                                </div>
                                <div class="col-xs-5" style="margin-top: 60px">
                                    <table class="table table__legend">
                                        <tbody>
                                        <tr>
                    ...
                    <div class="row workstat_block container-works">
                        <div class="col-sm-12">
                            ...
                            <div class="row workstat-graph">
                                ...
                                @else
                                    <div class="col-sm-7">
                                        <img style="margin-bottom: 10px" src="https://quickchart.io/chart?width=100&height=100&c={type:'doughnut',data:{datasets:[{data: [<?php echo implode(",",$country_count);?>]}]}}">
                    ...
                    <div class="row workstat_block container-city">
                        <div class="col-sm-12">
                            ...
                            @else
                                <div class="row workstat-graph">
                                    <div class="col-sm-12">
                                        <img style="margin-bottom: 10px" src="https://quickchart.io/chart?width=100&height=100&c={type:'horizontalBar',data:{labels: ['{{ trans('all.active') }}', '{{ trans('all.planned') }}', '{{ trans('all.completed') }}', '{{ trans('all.canceled') }}'],datasets:[{data: [<?php echo implode(",",$orders_chart);?>]}]}}">
                                    </div>
                                </div>
                                <div class="row workstat-row">
                    ...
                    <div class="row workstat_block container-city">
                        <div class="col-sm-12">
                            ...
                            <div class="row workstat-graph">
                                ...
                                @else
                                    <div class="col-sm-7">
                                        <img style="margin-bottom: 10px" src="https://quickchart.io/chart?width=100&height=100&c={type:'doughnut',data:{datasets:[{data: [<?php echo implode(",",array_values($city_count));?>]}]}}">
